# Rank-k Guard v2 (fresh rows) - Job 461624 - shard 0 of 1

Output JSON: `docs/selfaddress_l0_27b_property_shard0of1.json`
Rows: 26 prepared from 26 fresh-selection rows.

## Causal arms (row-paired bootstrap vs in-job unhinted baseline)

| arm | P(strong) | dP vs reference (CI95) | reference |
| --- | ---: | ---: | --- |
| l0_percand_fire | 0.019 | - | none |
