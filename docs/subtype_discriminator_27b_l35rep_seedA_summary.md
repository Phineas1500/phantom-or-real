# Subtype Capture-Ladder Discriminator - Job 458376

Output JSON: `docs/subtype_discriminator_27b_l35rep_seedA.json`
...
| --- | ---: | ---: | --- |
| baseline | 0.188 | - | none |
| old_trio_full_replace_L30_40_45 | 0.234 | +0.047 [-0.164, +0.258] | baseline |
