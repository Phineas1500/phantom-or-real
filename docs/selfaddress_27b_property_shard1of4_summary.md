# Rank-k Guard v2 (fresh rows) - Job 461629 - shard 1 of 4

Output JSON: `docs/selfaddress_27b_property_shard1of4.json`
...
| --- | ---: | ---: | --- |
| matched_bestofN_unsteered | 0.056 | -0.006 [-0.030, +0.015] | unhinted_baseline |
| percand_fire_L30 | 0.091 | +0.027 [-0.001, +0.069] | unhinted_baseline |
